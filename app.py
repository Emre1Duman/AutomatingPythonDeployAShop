...
def home():
    return ("<h1><b>Welcome</b> to the Animal Shop</h1> <p>Browse our <a href='/api/stock'>stock</a></p> <p>Our most expensive <a href='/api?id=3'>Animal!</a></p> <p>Our cheapest <a href='/api/somearea?price=2'>Animal</a> for you peasants</p>")
